...
// 1. The full WDL JSON landing page from skill references/examples.md
const landingPageWDL = {
  ...
  COMPONENTS: [
    {
      ...
      attr: {
        ...
        '.version_badge': { class: 'text-xs font-mono text-indigo-600 bg-indigo-50 px-2.5 py-1 rounded-full border border-indigo-100 font-semibold', text: 'v1.0' },
    ...
    },
    {
      ...
      attr: {
        ...
        '.cta_secondary': { class: 'text-gray-700 hover:text-gray-900 px-6 py-3 rounded-xl border border-gray-300 font-semibold transition hover:bg-gray-50', href: 'https://github.com', text: 'GitHub Repository' }
      }
    },
    {
      layers: 'section.features>div.container>div.header_block>h2.sec_title+p.sec_sub<<div.grid_shell>div.feature-card*features>div.icon_box+h3.card_title+p.card_desc',
      attr: {
    ...
    {
      layers: 'footer.site_footer>div.footer_container>p.copyright+p.meta',
      attr: {
  ...
  DATA: {
    ...
    navLinks: [
      ...
      { label: 'Specification', href: 'https://agentskills.io' },
      { label: 'GitHub', href: 'https://github.com' }
    ],
    features: [
      { badge: '⚡', title: 'Zero Client Bundle', description: 'Compiles WDL JSON directly into deterministic, minimal server-rendered HTML.' },
      { badge: '🧩', title: 'Alpine.js Native', description: 'Declarative state binding without complex frontend build toolchains or SPA overhead.' },
      { badge: '🎨', title: 'Tailwind CSS Built-in', description: 'Automatic utility styling, design tokens, and CSS custom property cascading.' }
    ],
    __seo: {
      title: 'RuledWDL — Live Skill Verification',
...
async function buildLivePreview() {
  ...
  const { html } = await composePage(store, 'skill-verification', landingPageWDL);
