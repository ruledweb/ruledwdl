...
The **`COMPONENTS v2.0`** specification expands WDL Layers expressions with multi-level repeater de-indentation (`<*N`), absolute depth referencing (`<@N`), and automatic `wdl-comp="{semantic-id}"` attribute generation.
