...
- **Never Bloat Monolithic Files**: Never allow single files to accumulate all UI, state, history, and inspector logic into bloated monoliths. Break down features into modular ESM files (e.g., `src/history.js`, `src/component-binding.js`, `src/markdown-editor.js`, `src/inspector.js`).
